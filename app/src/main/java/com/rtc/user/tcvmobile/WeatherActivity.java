...
import com.rtc.user.tcvmobile.data.Condition;
import com.rtc.user.tcvmobile.data.LocationResult;
import com.rtc.user.tcvmobile.listener.GeocodingServiceListener;
import com.rtc.user.tcvmobile.listener.WeatherServiceListener;
import com.rtc.user.tcvmobile.service.GoogleMapsGeocodingService;
import com.rtc.user.tcvmobile.service.WeatherCacheService;
import com.rtc.user.tcvmobile.service.YahooWeatherService;
   ...
   @Override
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
            ...
            finish();
            Intent dias = new Intent(getApplicationContext(),MainActivity.class);
            startActivity(dias);
            return true;
        }
